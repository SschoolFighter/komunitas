...
<div class="widgetlp widget-4 widget-body-white widget-tabs widget-tabs-2">
...
<div class="heading-buttons">
	<div class="pull-left">
		<h4 class="heading"><?php
			...
			echo 'Jenis : '.form_dropdown('jenis', array(''=>'-- Semua --','Uang'=>'Uang'), $this->input->get('jenis'), 'onChange="this.form.submit()"');
			?>
		</h4>
	</div>
