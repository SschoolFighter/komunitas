...
<div class="widgettp widget-4 row-fluid widget-tabs widget-tabs-2">
...
<?php $this->load->view('template/menu_tab', array('hal'=>'pinjaman'));?>
	...
	<div class="input-append control-group">
	  	<label class="no_anggotap" for="kode">NO ANGGOTA</label>
	  	<div class="tambahp"> 
	  		<input class="span12" id="kode" name="kode" type="text" placeholder="NO ANGGOTA" onkeypress="return isNumberKey(event)" value="<?php echo $keyword; ?>" autofocus required/>
...
if($keyword!="")
{
	...
	foreach ($result as $row);
		if(!$result)
		{
			echo "<h3 style='background: lightskyblue; padding: 20px 20px; width: 300px; width: 300px; border-top-left-radius: 85px; border-top-right-radius: 0px; border-bottom-left-radius: 0px; border-bottom-right-radius: 85px; margin-left: 565px; margin-top: -70px; font-size: 18px; text-align: center;'>Data Tidak ditemukan</h3>";
		}
		else if($row->pinjaman_id>0 && $row->pinjaman_status < $row->pinjaman_lama)
		{
			echo "<h3 style='background: lightskyblue; padding: 20px 20px; width: 300px; width: 300px; border-top-left-radius: 85px; border-top-right-radius: 0px; border-bottom-left-radius: 0px; border-bottom-right-radius: 85px; margin-left: 565px; margin-top: -70px; font-size: 18px; text-align: center;'>Pinjaman sebelumnya Belum lunas</h3>";
		}
		else
		{
...
<!-- 			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls"><input name="bunga" class="span1" id="bunga" value="<?php echo $key->bunga_simpanan?>" type="text" readonly/> %
...
<div class="form-actionstp" style="display:table;">
