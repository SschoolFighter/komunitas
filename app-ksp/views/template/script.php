...
<!-- JQueryUI v1.9.2 -->
	...
	<!-- effect Snow -->
	<script src="/ksp-master/js/particles.min.js"></script>
	<script src="/ksp-master/js/app.js"></script>

	<!-- effect Typed -->
	<script src="/ksp-master/js/Typed.js"></script>
	<script type="text/javascript">
		var typed = new Typed(".lgn-txt", {
			strings: [
			//"Selamat Datang di Website Arta Mulia",
			//"Website Yang Bertema",
			//"Koperasi Simpan Pinjam",
			//"Masih Banyak Kekurangan",
			//"Pada Website Ini",
			//"Jadi Harap Di maklumin yah :)"
