...
<div class="widgetas widget-4 row-fluid widget-tabs widget-tabs-2">

<?php $this->load->view('template/menu_tab', array('hal'=>'simpanan'));?>
	<form method="get" class="form-horizontal">
	<fieldset>
	<div class="input-append control-group">
	  	<label class="n_agts" for="kode">No Anggota</label>
	  	<div class="controls"> 
	  		<input class="span12" id="kode" name="kode" type="text" placeholder="NO ANGGOTA" value="<?php echo $keyword; ?>" autofocus required/>
