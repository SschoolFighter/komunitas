...
<div class="container-fluid fixed">
	<div id="content">
<div class="widgets widget-4 row-fluid widget-tabs widget-tabs-2">
...
<?php $this->load->view('template/menu_tab', array('hal'=>'simpanan'));?>
	...
	<div class="input-append control-group">
	  	<label class="no_anggotas" for="kode">NO ANGGOTA</label>
	  	<div class="tambahs"> 
	  	...
	  	<button class="btn_tambahs" type="submit"><i class="icon-search"></i></button></div>
	</div>
	</fieldset>
	</form>
<!-- </div> -->
    ...
    function buatrp($angka){
	 ...
	 if($keyword!=""){
	 	$result = $this->mdb->formSimpan($keyword);
			...
			if(!$result){echo "<h3 style='background: lightskyblue; padding: 20px 20px; width: 300px; width: 300px; border-top-left-radius: 85px; border-top-right-radius: 0px; border-bottom-left-radius: 0px; border-bottom-right-radius: 85px; margin-left: 565px; margin-top: -70px; font-size: 18px; text-align: center;'>Data Tidak ditemukan</h3>";}else{ ?>
...
<div class="widget widget-4 widget-body-white">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="span6" id="username" value="<?php echo $row->nama?>" type="text" disabled/>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="span6" id="saldo" value="<?php echo buatrp($row->saldo)?>" type="text" disabled/>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="span6" id="keanggotaan" value="<?php echo $key->jenis?>" type="text" disabled/>
				</div>
			</div>
