	<div class="container-fluid fixed">
		<div id="content">
			<div class="widgetn widget-4 row-fluid widget-tabs widget-tabs-2">
	...
	<div class="row-fluid">
		<div class="span6">
			<div class="control-group">
				<label class="n_nasabah" for="firstname">NO NASABAH</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="nm" for="lastname">NAMA</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="alt" for="alamat">ALAMAT</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="hdp" for="hp">HP</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="kgn" for="lastname">KEANGGOTAAN</label>
				<div class="controls">
					<?php 
			...
			<div class="control-group">
				<label class="tgl_m" for="lembar2">TANGGAL MASUK</label>
				<div class="controls">
